...
function marcello_scavo_theme_setup() {
	...
	register_nav_menus(
		array(
			'primary' => __( 'Menu Principale', 'marcello-scavo' ),
			'footer'  => __( 'Menu Footer', 'marcello-scavo' ),
			'social'  => __( 'Social Media', 'marcello-scavo' ),
		)
	);
	...
	load_theme_textdomain( 'marcello-scavo', get_template_directory() . '/languages' );
...
function marcello_scavo_widgets_init() {
	register_sidebar(
		array(
			'name'          => __( 'Sidebar Principale', 'marcello-scavo' ),
			'id'            => 'primary-sidebar',
			'description'   => __( 'Aggiungi widget qui per apparire nella sidebar.', 'marcello-scavo' ),
	...
	register_sidebar(
		array(
			'name'          => __( 'Footer Colonna 1', 'marcello-scavo' ),
			'id'            => 'footer-1',
			'description'   => __( 'Widget per la prima colonna del footer.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Footer Colonna 2', 'marcello-scavo' ),
			'id'            => 'footer-2',
			'description'   => __( 'Widget per la seconda colonna del footer.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Footer Colonna 3', 'marcello-scavo' ),
			'id'            => 'footer-3',
			'description'   => __( 'Widget per la terza colonna del footer.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Social Media', 'marcello-scavo' ),
			'id'            => 'social-media',
			'description'   => __( 'Area widget per contenuti social media (Instagram feed, etc.).', 'marcello-scavo' ),
	...
	register_sidebar(
		array(
			'name'          => __( 'Recensioni Clienti', 'marcello-scavo' ),
			'id'            => 'reviews-section',
			'description'   => __( 'Area widget per recensioni Google e testimonianze clienti.', 'marcello-scavo' ),
	...
	register_sidebar(
		array(
			'name'          => __( 'Prenotazione Booking', 'marcello-scavo' ),
			'id'            => 'booking-section',
			'description'   => __( 'Area widget per sistemi di prenotazione (Bookly, form contatti, etc.).', 'marcello-scavo' ),
	...
	register_sidebar(
		array(
			'name'          => __( 'Galleria Artistica', 'marcello-scavo' ),
			'id'            => 'gallery-showcase',
			'description'   => __( 'Area widget per mostrare la galleria dei lavori artistici e tatuaggi.', 'marcello-scavo' ),
	...
	register_sidebar(
		array(
			'name'          => __( 'Uploader Sicuro', 'marcello-scavo' ),
			'id'            => 'secure-uploader',
			'description'   => __( 'Area widget per il caricamento sicuro di immagini nei media WordPress.', 'marcello-scavo' ),
	...
	register_sidebar(
		array(
			'name'          => __( '📧 Sezione Contatti', 'marcello-scavo' ),
			'id'            => 'contact-section',
			'description'   => __( 'Area widget per personalizzare la sezione "Contattaci per informazioni". Include contenuto di fallback accattivante.', 'marcello-scavo' ),
	...
	register_sidebar(
		array(
			'name'          => __( '🗺️ Mappa Localizzazione', 'marcello-scavo' ),
			'id'            => 'location-map',
			'description'   => __( 'Area widget per personalizzare la mappa di localizzazione aziendale. Supporta Google Maps, OpenStreetMap e mappe personalizzate.', 'marcello-scavo' ),
			'before_widget' => '',
			'after_widget'  => '',
			'before_title'  => '',
			'after_title'   => '',
...
function marcello_scavo_custom_post_types() {
	...
	register_post_type(
		...
		array(
			'labels'             => array(
				'name'               => __( 'Portfolio', 'marcello-scavo' ),
				'singular_name'      => __( 'Lavoro Portfolio', 'marcello-scavo' ),
				'add_new'            => __( 'Aggiungi Nuovo', 'marcello-scavo' ),
				'add_new_item'       => __( 'Aggiungi Nuovo Lavoro', 'marcello-scavo' ),
				'edit_item'          => __( 'Modifica Lavoro', 'marcello-scavo' ),
				'new_item'           => __( 'Nuovo Lavoro', 'marcello-scavo' ),
				'view_item'          => __( 'Visualizza Lavoro', 'marcello-scavo' ),
				'search_items'       => __( 'Cerca Lavori', 'marcello-scavo' ),
				'not_found'          => __( 'Nessun lavoro trovato', 'marcello-scavo' ),
				'not_found_in_trash' => __( 'Nessun lavoro nel cestino', 'marcello-scavo' ),
			),
			'public'             => true,
	...
	register_post_type(
		...
		array(
			'labels'             => array(
				'name'               => __( 'Galleria', 'marcello-scavo' ),
				'singular_name'      => __( 'Immagine Galleria', 'marcello-scavo' ),
				'add_new'            => __( 'Aggiungi Nuova', 'marcello-scavo' ),
				'add_new_item'       => __( 'Aggiungi Nuova Immagine', 'marcello-scavo' ),
				'edit_item'          => __( 'Modifica Immagine', 'marcello-scavo' ),
				'new_item'           => __( 'Nuova Immagine', 'marcello-scavo' ),
				'view_item'          => __( 'Visualizza Immagine', 'marcello-scavo' ),
				'search_items'       => __( 'Cerca Immagini', 'marcello-scavo' ),
				'not_found'          => __( 'Nessuna immagine trovata', 'marcello-scavo' ),
				'not_found_in_trash' => __( 'Nessuna immagine nel cestino', 'marcello-scavo' ),
			),
			'public'             => true,
			'publicly_queryable' => true,
			'show_ui'            => true,
	...
	register_post_type(
		...
		array(
			'labels'             => array(
				'name'               => __( 'Prodotti Shop', 'marcello-scavo' ),
				'singular_name'      => __( 'Prodotto', 'marcello-scavo' ),
				'add_new'            => __( 'Aggiungi Prodotto', 'marcello-scavo' ),
				'add_new_item'       => __( 'Aggiungi Nuovo Prodotto', 'marcello-scavo' ),
				'edit_item'          => __( 'Modifica Prodotto', 'marcello-scavo' ),
				'new_item'           => __( 'Nuovo Prodotto', 'marcello-scavo' ),
				'view_item'          => __( 'Visualizza Prodotto', 'marcello-scavo' ),
				'search_items'       => __( 'Cerca Prodotti', 'marcello-scavo' ),
				'not_found'          => __( 'Nessun prodotto trovato', 'marcello-scavo' ),
				'not_found_in_trash' => __( 'Nessun prodotto nel cestino', 'marcello-scavo' ),
			),
			'public'             => true,
			'publicly_queryable' => true,
			'show_ui'            => true,
...
function marcello_scavo_custom_taxonomies() {
	...
	register_taxonomy(
		...
		array(
			'labels'             => array(
				'name'          => __( 'Categorie Portfolio', 'marcello-scavo' ),
				'singular_name' => __( 'Categoria Portfolio', 'marcello-scavo' ),
				'search_items'  => __( 'Cerca Categorie', 'marcello-scavo' ),
				'all_items'     => __( 'Tutte le Categorie', 'marcello-scavo' ),
				'edit_item'     => __( 'Modifica Categoria', 'marcello-scavo' ),
				'update_item'   => __( 'Aggiorna Categoria', 'marcello-scavo' ),
				'add_new_item'  => __( 'Aggiungi Nuova Categoria', 'marcello-scavo' ),
				'new_item_name' => __( 'Nome Nuova Categoria', 'marcello-scavo' ),
				'menu_name'     => __( 'Categorie', 'marcello-scavo' ),
			),
			'hierarchical'       => true,
			'public'             => true,
			'publicly_queryable' => true,
	...
	register_taxonomy(
		...
		array(
			'labels'             => array(
				'name'          => __( 'Tag Portfolio', 'marcello-scavo' ),
				'singular_name' => __( 'Tag Portfolio', 'marcello-scavo' ),
				'search_items'  => __( 'Cerca Tag', 'marcello-scavo' ),
				'all_items'     => __( 'Tutti i Tag', 'marcello-scavo' ),
				'edit_item'     => __( 'Modifica Tag', 'marcello-scavo' ),
				'update_item'   => __( 'Aggiorna Tag', 'marcello-scavo' ),
				'add_new_item'  => __( 'Aggiungi Nuovo Tag', 'marcello-scavo' ),
				'new_item_name' => __( 'Nome Nuovo Tag', 'marcello-scavo' ),
				'menu_name'     => __( 'Tag', 'marcello-scavo' ),
			),
			'hierarchical'       => false,
			'public'             => true,
			'publicly_queryable' => true,
	...
	register_taxonomy(
		...
		array(
			'labels'             => array(
				'name'          => __( 'Categorie Galleria', 'marcello-scavo' ),
				'singular_name' => __( 'Categoria Galleria', 'marcello-scavo' ),
				'search_items'  => __( 'Cerca Categorie', 'marcello-scavo' ),
				'all_items'     => __( 'Tutte le Categorie', 'marcello-scavo' ),
				'edit_item'     => __( 'Modifica Categoria', 'marcello-scavo' ),
				'update_item'   => __( 'Aggiorna Categoria', 'marcello-scavo' ),
...
function marcello_scavo_add_meta_boxes() {
	...
	add_meta_box(
		'portfolio_details',
		__( 'Dettagli Portfolio', 'marcello-scavo' ),
	...
	add_meta_box(
		'gallery_details',
		__( 'Dettagli Galleria', 'marcello-scavo' ),
	...
	add_meta_box(
		'product_details',
		__( 'Dettagli Prodotto', 'marcello-scavo' ),
...
function marcello_scavo_portfolio_meta_box_callback( $post ) {
	...
	<table class="form-table">
		<tr>
			<th><label for="portfolio_client_name"><?php _e( 'Nome Cliente', 'marcello-scavo' ); ?></label></th>
		...
		<tr>
			<th><label for="portfolio_project_date"><?php _e( 'Data Progetto', 'marcello-scavo' ); ?></label></th>
		...
		<tr>
			<th><label for="portfolio_project_location"><?php _e( 'Luogo', 'marcello-scavo' ); ?></label></th>
			<td>
				<select id="portfolio_project_location" name="portfolio_project_location" class="regular-text">
					<option value=""><?php _e( 'Seleziona Luogo', 'marcello-scavo' ); ?></option>
					<option value="milano" <?php selected( $project_location, 'milano' ); ?>><?php _e( 'Milano', 'marcello-scavo' ); ?></option>
					<option value="messina" <?php selected( $project_location, 'messina' ); ?>><?php _e( 'Messina', 'marcello-scavo' ); ?></option>
					<option value="altro" <?php selected( $project_location, 'altro' ); ?>><?php _e( 'Altro', 'marcello-scavo' ); ?></option>
				</select>
			</td>
		</tr>
		<tr>
			<th><label for="portfolio_project_type"><?php _e( 'Tipo Progetto', 'marcello-scavo' ); ?></label></th>
			<td>
				<select id="portfolio_project_type" name="portfolio_project_type" class="regular-text">
					<option value=""><?php _e( 'Seleziona Tipo', 'marcello-scavo' ); ?></option>
					<option value="tattoo" <?php selected( $project_type, 'tattoo' ); ?>><?php _e( 'Tatuaggio', 'marcello-scavo' ); ?></option>
					<option value="illustration" <?php selected( $project_type, 'illustration' ); ?>><?php _e( 'Illustrazione', 'marcello-scavo' ); ?></option>
					<option value="graphic_design" <?php selected( $project_type, 'graphic_design' ); ?>><?php _e( 'Grafica', 'marcello-scavo' ); ?></option>
				</select>
			</td>
		</tr>
		<tr>
			<th><label for="portfolio_project_duration"><?php _e( 'Durata (ore)', 'marcello-scavo' ); ?></label></th>
...
function marcello_scavo_gallery_meta_box_callback( $post ) {
	...
	<table class="form-table">
		<tr>
			<th><label for="gallery_image_caption"><?php _e( 'Didascalia Immagine', 'marcello-scavo' ); ?></label></th>
			<td>
				...
				<p class="description"><?php _e( 'Descrizione che apparirà sotto l\'immagine nella galleria.', 'marcello-scavo' ); ?></p>
			</td>
		</tr>
		<tr>
			<th><label for="gallery_image_alt_text"><?php _e( 'Testo Alternativo', 'marcello-scavo' ); ?></label></th>
			<td>
				...
				<p class="description"><?php _e( 'Testo alternativo per l\'accessibilità.', 'marcello-scavo' ); ?></p>
			</td>
		</tr>
		<tr>
			<th><label for="gallery_image_technique"><?php _e( 'Tecnica', 'marcello-scavo' ); ?></label></th>
			<td>
				<select id="gallery_image_technique" name="gallery_image_technique" class="regular-text">
					<option value=""><?php _e( 'Seleziona Tecnica', 'marcello-scavo' ); ?></option>
					<option value="olio_su_tela" <?php selected( $image_technique, 'olio_su_tela' ); ?>><?php _e( 'Olio su tela', 'marcello-scavo' ); ?></option>
					<option value="acrilico" <?php selected( $image_technique, 'acrilico' ); ?>><?php _e( 'Acrilico', 'marcello-scavo' ); ?></option>
					<option value="disegno_matita" <?php selected( $image_technique, 'disegno_matita' ); ?>><?php _e( 'Disegno a matita', 'marcello-scavo' ); ?></option>
					<option value="tatuaggio_blackwork" <?php selected( $image_technique, 'tatuaggio_blackwork' ); ?>><?php _e( 'Tatuaggio Blackwork', 'marcello-scavo' ); ?></option>
					<option value="tatuaggio_realistico" <?php selected( $image_technique, 'tatuaggio_realistico' ); ?>><?php _e( 'Tatuaggio Realistico', 'marcello-scavo' ); ?></option>
					<option value="tatuaggio_geometrico" <?php selected( $image_technique, 'tatuaggio_geometrico' ); ?>><?php _e( 'Tatuaggio Geometrico', 'marcello-scavo' ); ?></option>
					<option value="watercolor" <?php selected( $image_technique, 'watercolor' ); ?>><?php _e( 'Acquerello', 'marcello-scavo' ); ?></option>
					<option value="misto" <?php selected( $image_technique, 'misto' ); ?>><?php _e( 'Tecnica mista', 'marcello-scavo' ); ?></option>
				</select>
			</td>
		</tr>
		<tr>
			<th><label for="gallery_image_dimensions"><?php _e( 'Dimensioni', 'marcello-scavo' ); ?></label></th>
			<td>
				...
				<p class="description"><?php _e( 'Dimensioni dell\'opera o area del tatuaggio.', 'marcello-scavo' ); ?></p>
			</td>
		</tr>
		<tr>
			<th><label for="gallery_creation_date"><?php _e( 'Data di Creazione', 'marcello-scavo' ); ?></label></th>
		...
		<tr>
			<th><label for="gallery_is_featured"><?php _e( 'Immagine in Evidenza', 'marcello-scavo' ); ?></label></th>
			<td>
				<label>
					<input type="checkbox" id="gallery_is_featured" name="gallery_is_featured" value="1" <?php checked( $is_featured, '1' ); ?> />
					<?php _e( 'Mostra questa immagine in evidenza nella galleria', 'marcello-scavo' ); ?>
				</label>
			</td>
		</tr>
		<tr>
			<th><label for="gallery_featured_order"><?php _e( 'Ordine in Evidenza', 'marcello-scavo' ); ?></label></th>
			<td>
				...
				<p class="description"><?php _e( 'Ordine di visualizzazione tra le immagini in evidenza (0 = primo).', 'marcello-scavo' ); ?></p>
			</td>
		</tr>
	</table>
	<?php
...
function marcello_scavo_get_bookly_form() {
	...
	return $debug_info . '<div class="bookly-fallback">
        <h3>' . __( 'Sistema di Prenotazione Non Disponibile', 'marcello-scavo' ) . '</h3>
        <p>' . __( 'Il sistema di prenotazione è temporaneamente non disponibile. Contattaci direttamente per prenotare il tuo appuntamento.', 'marcello-scavo' ) . '</p>
        <div class="fallback-actions">
            <a href="tel:+393123456789" class="btn btn-primary">
                <i class="fas fa-phone"></i> ' . __( 'Chiama Ora', 'marcello-scavo' ) . '
            </a>
            <a href="mailto:info@marcelloscavo.com" class="btn btn-outline-primary">
                <i class="fas fa-envelope"></i> ' . __( 'Scrivi Email', 'marcello-scavo' ) . '
            </a>
        </div>
    </div>';
}
...
function marcello_scavo_product_meta_box_callback( $post ) {
	...
	<table class="form-table">
		<tr>
			<th><label for="product_price"><?php _e( 'Prezzo (€)', 'marcello-scavo' ); ?></label></th>
		...
		<tr>
			<th><label for="product_type"><?php _e( 'Tipo Prodotto', 'marcello-scavo' ); ?></label></th>
			<td>
				<select id="product_type" name="product_type" class="regular-text" required>
					<option value=""><?php _e( 'Seleziona Tipo', 'marcello-scavo' ); ?></option>
					<option value="flash_tattoo" <?php selected( $product_type, 'flash_tattoo' ); ?>><?php _e( 'Flash Tattoo', 'marcello-scavo' ); ?></option>
					<option value="merchandise" <?php selected( $product_type, 'merchandise' ); ?>><?php _e( 'Merchandising', 'marcello-scavo' ); ?></option>
					<option value="print" <?php selected( $product_type, 'print' ); ?>><?php _e( 'Stampa', 'marcello-scavo' ); ?></option>
					<option value="digital" <?php selected( $product_type, 'digital' ); ?>><?php _e( 'Digitale', 'marcello-scavo' ); ?></option>
				</select>
			</td>
		</tr>
		<tr>
			<th><label for="product_stock"><?php _e( 'Quantità in Stock', 'marcello-scavo' ); ?></label></th>
			<td><input type="number" id="product_stock" name="product_stock" value="<?php echo esc_attr( $product_stock ); ?>" class="small-text" min="0" /></td>
		</tr>
		<tr>
			<th><label for="product_sku"><?php _e( 'Codice Prodotto (SKU)', 'marcello-scavo' ); ?></label></th>
...
function marcello_scavo_handle_contact_form() {
	...
	if ( ! wp_verify_nonce( $_POST['nonce'], 'marcello_scavo_nonce' ) ) {
		wp_die( __( 'Errore di sicurezza', 'marcello-scavo' ) );
	}
	...
	if ( empty( $name ) || empty( $email ) || empty( $message ) ) {
		wp_send_json_error( array( 'message' => __( 'Tutti i campi sono obbligatori', 'marcello-scavo' ) ) );
	}

	if ( ! is_email( $email ) ) {
		wp_send_json_error( array( 'message' => __( 'Email non valida', 'marcello-scavo' ) ) );
	}

	// Prepare email
	$admin_email   = get_option( 'admin_email' );
	$email_subject = sprintf( __( 'Nuovo messaggio da %1$s: %2$s', 'marcello-scavo' ), $name, $subject );
	...
	if ( wp_mail( $admin_email, $email_subject, $email_message, $headers ) ) {
		wp_send_json_success( array( 'message' => __( 'Messaggio inviato con successo!', 'marcello-scavo' ) ) );
	} else {
		wp_send_json_error( array( 'message' => __( 'Errore nell\'invio del messaggio', 'marcello-scavo' ) ) );
	}
}
...
function marcello_scavo_handle_newsletter() {
	...
	$admin_email = get_option( 'admin_email' );
	$subject     = __( 'Nuova iscrizione newsletter', 'marcello-scavo' );
	$message     = sprintf( __( 'Nuova iscrizione alla newsletter: %s', 'marcello-scavo' ), $email );

	if ( wp_mail( $admin_email, $subject, $message ) ) {
		wp_send_json_success( array( 'message' => __( 'Iscrizione completata!', 'marcello-scavo' ) ) );
	} else {
		wp_send_json_error( array( 'message' => __( 'Errore nell\'iscrizione', 'marcello-scavo' ) ) );
	}
}
...
function marcello_scavo_handle_gallery_filter() {
	...
	if ( ! $has_items ) {
		if ( current_user_can( 'manage_options' ) ) {
			...
			$html .= '<h3>' . __( 'Nessuna immagine in questa categoria', 'marcello-scavo' ) . '</h3>';
			$html .= '<p>' . __( 'Non ci sono ancora immagini per questa categoria.', 'marcello-scavo' ) . '</p>';
			$html .= '<p><a href="' . admin_url( 'post-new.php?post_type=gallery' ) . '" class="button">' . __( 'Aggiungi nuova immagine', 'marcello-scavo' ) . '</a></p>';
			$html .= '</div>';
		} else {
			$html = '<div class="no-gallery-items"><p>' . __( 'Nessuna immagine trovata per questa categoria.', 'marcello-scavo' ) . '</p></div>';
		}
	}
...
function marcello_scavo_customize_register( $wp_customize ) {
	...
	if ( isset( $_GET['url'] ) ) {
		...
		if ( strpos( $current_url, '/portfolio' ) !== false ||
	...
	// Metodo 2: Controlla tramite REQUEST_URI
	if ( ! $is_portfolio_page && isset( $_SERVER['REQUEST_URI'] ) ) {
		$request_uri = $_SERVER['REQUEST_URI'];
		if ( strpos( $request_uri, '/portfolio' ) !== false ||
			strpos( $request_uri, 'portfolio_category' ) !== false ) {
			$is_portfolio_page = true;
			$is_home_page      = false;
		}
	}

	// Metodo 3: Controlla tramite query vars nel Customizer
	if ( ! $is_portfolio_page && isset( $_GET['changeset_uuid'] ) ) {
		// Siamo nel Customizer, verifica la pagina preview
		global $wp_query;
		if ( is_tax( 'portfolio_category' ) || is_post_type_archive( 'portfolio' ) ||
			( isset( $_GET['portfolio'] ) || isset( $_GET['portfolio_category'] ) ) ) {
			$is_portfolio_page = true;
			$is_home_page      = false;
		}
	}
	...
	// ======================================
	// SEZIONI HOMEPAGE (solo se non siamo nel portfolio)
	// ======================================
	...
	if ( $is_home_page && ! $is_portfolio_page ) {
		...
		$wp_customize->add_section(
			'hero_section',
			array(
				'title'       => __( '🏠 Homepage - Sezione Hero', 'marcello-scavo' ),
				'priority'    => 30,
				'description' => __( 'Personalizza la sezione Hero della homepage.', 'marcello-scavo' ),
			)
		);
		...
		$wp_customize->add_control(
			'hero_label',
			array(
				'label'       => __( 'Etichetta Hero (sopra il titolo)', 'marcello-scavo' ),
				'description' => __( 'Inserisci in italiano - sarà tradotto automaticamente', 'marcello-scavo' ),
		...
		$wp_customize->add_control(
			'hero_title',
			array(
				'label'       => __( 'Titolo Hero Principale', 'marcello-scavo' ),
				'description' => __( 'Inserisci in italiano - sarà tradotto automaticamente. Usa &lt;br&gt; per andare a capo', 'marcello-scavo' ),
				'section'     => 'hero_section',
				'type'        => 'textarea',
			)
		);
		...
		$wp_customize->add_control(
			'hero_description',
			array(
				'label'   => __( 'Descrizione Hero', 'marcello-scavo' ),
				'section' => 'hero_section',
				'type'    => 'textarea',
			)
		);
		...
		$wp_customize->add_control(
			'hero_button_text',
			array(
				'label'       => __( 'Testo Bottone Hero', 'marcello-scavo' ),
				'description' => __( 'Inserisci in italiano - sarà tradotto automaticamente', 'marcello-scavo' ),
				'section'     => 'hero_section',
				'type'        => 'text',
			)
		...
		$wp_customize->add_section(
			'contact_info',
			array(
				'title'    => __( 'Informazioni Contatto', 'marcello-scavo' ),
				'priority' => 31,
			)
		);
		...
		$wp_customize->add_control(
			'contact_milano_address',
			array(
				'label'   => __( 'Indirizzo Milano', 'marcello-scavo' ),
		...
		$wp_customize->add_control(
			'contact_messina_address',
			array(
				'label'   => __( 'Indirizzo Messina', 'marcello-scavo' ),
				'section' => 'contact_info',
				'type'    => 'textarea',
			)
		);
		...
		$wp_customize->add_control(
			'contact_phone',
			array(
				'label'   => __( 'Telefono', 'marcello-scavo' ),
				'section' => 'contact_info',
				'type'    => 'text',
			)
		);
		...
		$wp_customize->add_section(
			'footer_layout',
			array(
				'title'       => __( 'Layout Footer', 'marcello-scavo' ),
				'priority'    => 32,
				'description' => __( 'Personalizza la struttura e il contenuto del footer.', 'marcello-scavo' ),
			)
		);
		...
		$wp_customize->add_control(
			'footer_layout_type',
			array(
				'label'       => __( 'Tipo Layout Footer', 'marcello-scavo' ),
				'section'     => 'footer_layout',
				'type'        => 'select',
				'choices'     => array(
					'one_column'    => __( 'Una Colonna', 'marcello-scavo' ),
					'two_columns'   => __( 'Due Colonne', 'marcello-scavo' ),
					'three_columns' => __( 'Tre Colonne (Default)', 'marcello-scavo' ),
					'four_columns'  => __( 'Quattro Colonne', 'marcello-scavo' ),
				),
				'description' => __( 'Scegli il numero di colonne per il footer. Cambierà automaticamente le aree widget disponibili.', 'marcello-scavo' ),
			)
		);
		...
		$wp_customize->add_control(
			'footer_social_style',
			array(
				'label'   => __( 'Stile Icone Social', 'marcello-scavo' ),
				'section' => 'footer_layout',
				'type'    => 'select',
				'choices' => array(
					'modern'  => __( 'Moderno (Circoli colorati)', 'marcello-scavo' ),
					'minimal' => __( 'Minimale (Solo icone)', 'marcello-scavo' ),
					'buttons' => __( 'Pulsanti con testo', 'marcello-scavo' ),
					'cards'   => __( 'Card social', 'marcello-scavo' ),
				),
			)
		);
		...
		$social_networks = array(
			'instagram' => array(
				'label'       => 'Instagram',
				'placeholder' => 'https://instagram.com/marcelloscavo_art',
			),
			'facebook'  => array(
				'label'       => 'Facebook',
				'placeholder' => 'https://facebook.com/marcelloscavo',
			),
			'tiktok'    => array(
				'label'       => 'TikTok',
				'placeholder' => 'https://tiktok.com/@marcello.scavo',
			),
			'youtube'   => array(
				'label'       => 'YouTube',
				'placeholder' => 'https://youtube.com/@MarcelloScavo',
			),
			'twitter'   => array(
				'label'       => 'Twitter/X',
				'placeholder' => 'https://twitter.com/marcelloscavo',
			),
			'linkedin'  => array(
				'label'       => 'LinkedIn',
				'placeholder' => 'https://linkedin.com/in/marcelloscavo',
			),
		);

		foreach ( $social_networks as $network => $data ) {
			$wp_customize->add_setting(
				"social_link_{$network}",
				array(
					'default'           => '',
		...
		// WhatsApp Booking Section (sempre visibile)
		$wp_customize->add_section(
			'whatsapp_booking',
			array(
				'title'       => __( '📱 WhatsApp Prenotazioni', 'marcello-scavo' ),
				'description' => __( 'Configurazione per il bottone "Prenota Consulenza" che invia un messaggio WhatsApp.', 'marcello-scavo' ),
				'priority'    => 35,
			)
		);
		...
		$wp_customize->add_control(
			'whatsapp_number',
			array(
				'label'       => __( 'Numero WhatsApp', 'marcello-scavo' ),
				'description' => __( 'Inserisci il numero in formato internazionale (es: 393331234567)', 'marcello-scavo' ),
		...
		$wp_customize->add_control(
			'whatsapp_message',
			array(
				'label'       => __( 'Messaggio WhatsApp', 'marcello-scavo' ),
				'description' => __( 'Messaggio che verrà precompilato quando l\'utente clicca "Prenota Consulenza".', 'marcello-scavo' ),
				'section'     => 'whatsapp_booking',
				'type'        => 'textarea',
			)
		);

	} // Fine sezioni homepage

	// ======================================
	// SEZIONI PORTFOLIO (solo se siamo nel portfolio)
	// ======================================

	if ( $is_portfolio_page ) {

		// Array delle 7 sezioni del portfolio
		$portfolio_sections = array(
			'hero'         => array(
				'title'        => '🎨 Portfolio Hero',
				'description'  => 'Personalizza colori, font e sfondi della sezione Hero del portfolio.',
				'default_bg'   => '#C9B05F', // Solo oro per hero
				'default_text' => '#FFFFFF', // Bianco su oro
			),
			'gallery'      => array(
				'title'        => '🖼️ Portfolio Galleria',
				'description'  => 'Personalizza colori, font e sfondi della sezione Galleria.',
				'default_bg'   => '#FFFFFF',
				'default_text' => '#273A59',
			),
			'recent'       => array(
				'title'        => '⭐ Portfolio Lavori Recenti',
				'description'  => 'Personalizza colori, font e sfondi della sezione Lavori Recenti.',
				'default_bg'   => '#FFFFFF',
				'default_text' => '#273A59',
			),
			'testimonials' => array(
				'title'        => '💬 Portfolio Testimonianze',
				'description'  => 'Personalizza colori, font e sfondi della sezione Testimonianze.',
				'default_bg'   => '#C9B05F',
				'default_text' => '#FFFFFF',
			),
			'cta'          => array(
				'title'        => '📞 Portfolio CTA/Booking',
				'description'  => 'Personalizza colori, font e sfondi della sezione CTA e Booking.',
				'default_bg'   => '#273A59',
				'default_text' => '#FFFFFF',
			),
			'why'          => array(
				'title'        => '🏆 Portfolio Perché Sceglierci',
				'description'  => 'Personalizza colori, font e sfondi della sezione Perché Sceglierci.',
				'default_bg'   => '#FFFFFF',
				'default_text' => '#273A59',
			),
			'contact'      => array(
				'title'        => '📧 Portfolio Contatti',
				'description'  => 'Personalizza colori, font e sfondi della sezione Contatti.',
				'default_bg'   => '#C9B05F',
				'default_text' => '#FFFFFF',
			),
		);

		// Crea sezioni per ogni parte del portfolio
		foreach ( $portfolio_sections as $section_key => $section_data ) {
			$section_id = "portfolio_{$section_key}_styling";
			...
			$wp_customize->add_section(
				...
				array(
					...
					'priority'    => 40 + array_search( $section_key, array_keys( $portfolio_sections ) ),
				)
			);

			// Colore di sfondo
			$wp_customize->add_setting(
				"portfolio_{$section_key}_bg_color",
				array(
					'default'           => $section_data['default_bg'],
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					"portfolio_{$section_key}_bg_color",
					array(
						'label'   => __( 'Colore Sfondo', 'marcello-scavo' ),
						'section' => $section_id,
					)
				)
			);
			...
			$wp_customize->add_setting(
				"portfolio_{$section_key}_text_color",
				array(
					'default'           => $section_data['default_text'],
					'sanitize_callback' => 'sanitize_hex_color',
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					"portfolio_{$section_key}_text_color",
					array(
						'label'   => __( 'Colore Testo Principale', 'marcello-scavo' ),
						'section' => $section_id,
					)
				)
			);
			...
			// Colore titoli
			$wp_customize->add_setting(
				"portfolio_{$section_key}_heading_color",
				array(
					'default'           => ( $section_data['default_bg'] === '#C9B05F' ) ? '#FFFFFF' : '#273A59',
					'sanitize_callback' => 'sanitize_hex_color',
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					"portfolio_{$section_key}_heading_color",
					array(
						'label'   => __( 'Colore Titoli', 'marcello-scavo' ),
						'section' => $section_id,
					)
				)
			);

			// Font famiglia per titoli
			$wp_customize->add_setting(
				"portfolio_{$section_key}_heading_font",
				array(
					'default'           => 'inherit',
					'sanitize_callback' => 'sanitize_text_field',
				)
			...
			$wp_customize->add_control(
				"portfolio_{$section_key}_heading_font",
				array(
					'label'   => __( 'Font Titoli', 'marcello-scavo' ),
					'section' => $section_id,
					'type'    => 'select',
					'choices' => array(
						...
						'"Playfair Display", serif' => 'Playfair Display (Elegant)',
						'"Montserrat", sans-serif'  => 'Montserrat (Modern)',
						'"Open Sans", sans-serif'   => 'Open Sans (Clean)',
					),
				)
			);
			...
			// Gradiente (opzionale)
			$wp_customize->add_setting(
				"portfolio_{$section_key}_use_gradient",
				array(
					'default'           => false,
			...
			$wp_customize->add_control(
				"portfolio_{$section_key}_use_gradient",
				array(
					'label'       => __( 'Usa Gradiente', 'marcello-scavo' ),
					'section'     => $section_id,
					'type'        => 'checkbox',
					'description' => __( 'Abilita sfondo gradiente invece del colore solido', 'marcello-scavo' ),
				)
			);

			// Colore gradiente finale
			$wp_customize->add_setting(
				"portfolio_{$section_key}_gradient_color",
				array(
					'default'           => '#273A59',
					'sanitize_callback' => 'sanitize_hex_color',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					"portfolio_{$section_key}_gradient_color",
					array(
						'label'       => __( 'Colore Gradiente Fine', 'marcello-scavo' ),
						'section'     => $section_id,
						'description' => __( 'Secondo colore per il gradiente (dal colore sfondo a questo)', 'marcello-scavo' ),
					)
				)
			);
		}
	} // Fine sezioni portfolio

	// ======================================
	// SEZIONI COMUNI (sempre visibili)
	// ======================================

	// Sezioni che devono essere sempre disponibili (come le impostazioni generali del tema)
	// Qui puoi aggiungere sezioni che devono essere visibili ovunque
}
add_action( 'customize_register', 'marcello_scavo_customize_register' );

/**
 * Script per rilevare automaticamente la pagina corrente nel Customizer
 */
function marcello_scavo_customizer_preview_script() {
	if ( is_customize_preview() ) {
		?>
		<script type="text/javascript">
		(function($) {
			// Rileva la pagina corrente e invia al Customizer
			$(document).ready(function() {
				var currentPage = 'home'; // Default
				
				// Controlla se siamo in una pagina portfolio
				if (document.body.classList.contains('tax-portfolio_category') || 
					document.body.classList.contains('post-type-archive-portfolio') ||
					window.location.href.indexOf('/portfolio') !== -1 ||
					window.location.href.indexOf('portfolio_category') !== -1) {
					currentPage = 'portfolio';
				}
				
				// Invia informazione al parent Customizer
				if (window.parent && window.parent.wp && window.parent.wp.customize) {
					window.parent.wp.customize.state('currentPageContext', currentPage);
					
					// Trigger evento personalizzato
					window.parent.wp.customize.bind('ready', function() {
						window.parent.wp.customize.trigger('page-context-change', currentPage);
					});
				}
			});
		})(jQuery);
...
add_action( 'wp_footer', 'marcello_scavo_customizer_preview_script' );

/**
 * Script per nascondere/mostrare sezioni del Customizer basate sulla pagina corrente
 */
function marcello_scavo_customizer_controls_script() {
	?>
	<script type="text/javascript">
	(function($) {
		wp.customize.bind('ready', function() {
			...
			var portfolioSections = [
				'portfolio_hero_styling',
				'portfolio_gallery_styling', 
				'portfolio_recent_styling',
				'portfolio_testimonials_styling',
				'portfolio_cta_styling',
				'portfolio_why_styling',
				'portfolio_contact_styling'
			];
			...
			function toggleSections(showPortfolio) {
				// Nasconde tutte le sezioni non pertinenti
				homeSections.forEach(function(sectionId) {
					var section = wp.customize.section(sectionId);
					if (section) {
						section.container.toggle(!showPortfolio);
					}
				});
				
				portfolioSections.forEach(function(sectionId) {
					var section = wp.customize.section(sectionId);
					if (section) {
						section.container.toggle(showPortfolio);
					}
			...
			// Rileva il cambio di pagina nel preview
			wp.customize.bind('page-context-change', function(context) {
				toggleSections(context === 'portfolio');
			});
			
			// Rileva automaticamente dalla URL del preview
			wp.customize.previewer.bind('ready', function() {
				var previewUrl = wp.customize.previewer.previewUrl();
				var isPortfolio = previewUrl.indexOf('/portfolio') !== -1 || 
								previewUrl.indexOf('portfolio_category') !== -1;
				toggleSections(isPortfolio);
			});
			
			// Ascolta i cambiamenti dell'URL del preview
...
add_action( 'customize_controls_print_scripts', 'marcello_scavo_customizer_controls_script' );

/**
 * Genera CSS dinamico per il portfolio basato sulle impostazioni del Customizer
 */
function marcello_scavo_portfolio_dynamic_css() {
	// CSS per ogni sezione del portfolio
	$sections = array( 'hero', 'gallery', 'recent', 'testimonials', 'cta', 'why', 'contact' );
	$css      = '';

	foreach ( $sections as $section ) {
		$bg_color       = get_theme_mod( "portfolio_{$section}_bg_color" );
		$text_color     = get_theme_mod( "portfolio_{$section}_text_color" );
		$heading_color  = get_theme_mod( "portfolio_{$section}_heading_color" );
		$heading_font   = get_theme_mod( "portfolio_{$section}_heading_font", 'inherit' );
		$use_gradient   = get_theme_mod( "portfolio_{$section}_use_gradient", false );
		$gradient_color = get_theme_mod( "portfolio_{$section}_gradient_color" );

		// Genera selettore CSS basato sulla sezione
		$selector = '';
		switch ( $section ) {
			case 'hero':
				...
				break;
			case 'gallery':
				$selector = '.portfolio-gallery-section';
				break;
			case 'recent':
				$selector = '.portfolio-latest-section';
				break;
			case 'testimonials':
				$selector = '.portfolio-testimonials-section';
				break;
			case 'cta':
				$selector = '.portfolio-cta-section';
				break;
			case 'why':
				$selector = '.portfolio-why-section';
				break;
			case 'contact':
		...
		if ( ! empty( $selector ) ) {
			$css .= "\n/* Portfolio {$section} section styling */\n";
			// Sfondo della sezione
			$css .= "{$selector} {\n";
			if ( $use_gradient && $bg_color && $gradient_color ) {
				$css .= "    background: linear-gradient(135deg, {$bg_color}, {$gradient_color}) !important;\n";
			} elseif ( $bg_color ) {
				$css .= "    background-color: {$bg_color} !important;\n";
			}
			$css .= "}\n\n";

			// Colore testo - SOLO elementi diretti, NON widget
			if ( $text_color ) {
				$css .= "{$selector} > .container > p,\n";
				$css .= "{$selector} > .container > .row > .col-* > p,\n";
				$css .= "{$selector} > .container > .section-content > p,\n";
				$css .= "{$selector} .section-text:not(.widget *),\n";
				$css .= "{$selector} .portfolio-content:not(.widget *) {\n";
				$css .= "    color: {$text_color} !important;\n";
				$css .= "}\n\n";
			}

			// Titoli e heading della sezione - ESCLUDI contenuti widget
			if ( $heading_color || $heading_font !== 'inherit' ) {
				$css .= "{$selector} > .container > h1, {$selector} > .container > h2, {$selector} > .container > h3,\n";
				$css .= "{$selector} > .container > .section-header h1, {$selector} > .container > .section-header h2,\n";
				$css .= "{$selector} .section-title, {$selector} .portfolio-hero-title, {$selector} .cta-title {\n";

				if ( $heading_color ) {
					$css .= "    color: {$heading_color} !important;\n";
				}

				if ( $heading_font !== 'inherit' ) {
					$css .= "    font-family: {$heading_font} !important;\n";
				}

				$css .= "}\n\n";
			}

			// Protezione FORTE per tutti i widget - SOVRASCRIVE tutto
			$css .= "{$selector} .widget {\n";
			$css .= "    color: auto !important;\n";
			$css .= "    background: transparent !important;\n";
			$css .= "}\n\n";

			// Applica solo a elementi NON recensioni
			$css .= "{$selector} .widget:not([class*='review']):not([class*='google']) *,\n";
			$css .= "{$selector} .widget p:not(.review-card *):not(.google-business-info *),\n";
			$css .= "{$selector} .widget div:not(.review-card):not(.reviews-carousel):not(.google-business-info),\n";
			$css .= "{$selector} .widget span:not(.review-card *):not(.google-business-info *),\n";
			$css .= "{$selector} .widget a:not(.review-card *):not(.google-business-info *) {\n";
			$css .= "    color: initial !important;\n";
			$css .= "    background: initial !important;\n";
			$css .= "}\n\n";

			// PROTEZIONE COMPLETA per widget recensioni Google - MANTIENI STILI ORIGINALI
			$css .= "{$selector} .reviews-carousel,\n";
			$css .= "{$selector} .reviews-carousel *,\n";
			$css .= "{$selector} .review-card,\n";
			$css .= "{$selector} .review-card *,\n";
			$css .= "{$selector} .google-business-info,\n";
			$css .= "{$selector} .google-business-info *,\n";
			$css .= "{$selector} .google-reviews-widget,\n";
			$css .= "{$selector} .google-reviews-widget *,\n";
			$css .= "{$selector} .review-item,\n";
			$css .= "{$selector} .review-item *,\n";
			$css .= "{$selector} .review-text,\n";
			$css .= "{$selector} .review-author,\n";
			$css .= "{$selector} .review-rating,\n";
			$css .= "{$selector} .review-header,\n";
			$css .= "{$selector} .review-header *,\n";
			$css .= "{$selector} .review-content,\n";
			$css .= "{$selector} .review-content *,\n";
			$css .= "{$selector} .reviewer-info,\n";
			$css .= "{$selector} .reviewer-info *,\n";
			$css .= "{$selector} .social-widget,\n";
			$css .= "{$selector} .social-widget * {\n";
			$css .= "    color: revert !important;\n";
			$css .= "    background: revert !important;\n";
			$css .= "    border: revert !important;\n";
			$css .= "    box-shadow: revert !important;\n";
			$css .= "}\n\n";

			// Forza colori dark su sfondo bianco per widget
			if ( $bg_color === '#FFFFFF' || $bg_color === '#ffffff' ) {
				$css .= "{$selector} .widget,\n";
				$css .= "{$selector} .widget * {\n";
			...
			// Specifico per la sezione hero: rimuovere gradiente blu se presente
			if ( $section === 'hero' ) {
				$css .= ".portfolio-hero::before,\n";
				$css .= ".portfolio-hero-bg {\n";
				$css .= "    background: none !important;\n";
				$css .= "}\n\n";

				$css .= ".portfolio-hero-overlay {\n";
				$css .= "    background: rgba(0, 0, 0, 0.3) !important;\n";
				$css .= "}\n\n";
			}

			// Regole aggiuntive per migliorare la leggibilità - ESCLUDI widget
			if ( $section === 'hero' || $bg_color === '#C9B05F' ) {
				$css .= "{$selector} > .container > p:not(.widget *),\n";
				$css .= "{$selector} .section-subtitle:not(.widget *),\n";
				$css .= "{$selector} .portfolio-hero-desc:not(.widget *) {\n";
				$css .= "    color: rgba(255, 255, 255, 0.9) !important;\n";
				$css .= "}\n\n";

				$css .= "{$selector} .section-divider, {$selector} .portfolio-hero-divider {\n";
				$css .= "    background-color: rgba(255, 255, 255, 0.8) !important;\n";
				$css .= "}\n\n";
			} elseif ( $bg_color === '#FFFFFF' ) {
				$css .= "{$selector} > .container > p:not(.widget *),\n";
				$css .= "{$selector} .section-subtitle:not(.widget *) {\n";
				$css .= "    color: rgba(39, 58, 89, 0.8) !important;\n";
				$css .= "}\n\n";

				$css .= "{$selector} .section-divider {\n";
				$css .= "    background-color: #C9B05F !important;\n";
				$css .= "}\n\n";
			}
		}
	}
...
/**
 * Aggiungi CSS dinamico nel head
 */
function marcello_scavo_portfolio_add_dynamic_css() {
	// Solo nelle pagine del portfolio
	if ( is_tax( 'portfolio_category' ) || is_post_type_archive( 'portfolio' ) || is_singular( 'portfolio' ) ) {
		$css = marcello_scavo_portfolio_dynamic_css();
		if ( ! empty( $css ) ) {
			echo '<style type="text/css" id="marcello-portfolio-dynamic-css">' . $css . '</style>';
		}
	}
}
add_action( 'wp_head', 'marcello_scavo_portfolio_add_dynamic_css' );
...
function handle_translation_ajax() {
	...
	$simple_translations = array(
		...
		'Scopri l\'essenza dei miei tatuaggi e opere d\'arte.' => array(
		...
		'Benvenuti nel mio mondo creativo, dove ogni storia racconta una storia, i miei tatuaggi e le opere d\'arte nascono dall\'ispirazione e dalla passione. Che tu stia cercando un tatuaggio personalizzato per il tuo corpo o un\'opera unica per la tua parete, sei nel posto giusto. Esplora il mio portfolio e lasciati ispirare dalla fusione di arte e tatuaggio.' => array(
	...
	foreach ( $texts as $text ) {
		...
		if ( $translation === $clean_text ) {
			$missing_translations = array(
				...
				'La filosofia di Marcello si basa sull\'ascolto attento delle esigenze del cliente e sulla traduzione delle loro idee in opere d\'arte durature. Ogni sessione è un momento di creazione condivisa, dove l\'esperienza e la creatività si fondono per dare vita a qualcosa di veramente speciale.' => array(
				...
				'THE ART OF TATTOO'                  => array(
					'en' => 'THE ART OF TATTOO',
					'es' => 'EL ARTE DEL TATUAJE',
				),
				'Discover the essence of my tattoos and works of art.' => array(
					'en' => 'Discover the essence of my tattoos and works of art.',
					'es' => 'Descubre la esencia de mis tatuajes y obras de arte.',
				),
				'About Me'                           => array(
				...
				// === SEZIONE SERVIZI ===
				'I nostri servizi'                   => array(
					'en' => 'Our Services',
					'es' => 'Nuestros Servicios',
				),
				'Scopri le nostre offerte principali, pensate per soddisfare le tue passioni.' => array(
				...
				'Vendita opere d\'arte'              => array(
					'en' => 'Art Sales',
					'es' => 'Venta de Obras de Arte',
				),
				'Esplora la nostra collezione di opere d\'arte uniche e porta a casa un pezzo di creatività.' => array(
				...
				'Mostra di tatuaggi'                 => array(
					'en' => 'Tattoo Shows',
					'es' => 'Exposiciones de Tatuajes',
				),
				'Assisti ai nostri eventi di tatuaggio, dove talenti internazionali mostrano le loro creazioni dal vivo.' => array(
				...
				'Prenotazione tatuaggi'              => array(
					'en' => 'Tattoo Booking',
					'es' => 'Reserva de Tatuajes',
				),
				'Prenota il tuo tatuaggio direttamente online e realizza il tuo design personalizzato con noi.' => array(
				...
				// === SEZIONE GALLERIA ===
				'Scopri le mie creazioni artistiche' => array(
					'en' => 'Discover My Artistic Creations',
					'es' => 'Descubre Mis Creaciones Artísticas',
				),
				'Esplora una collezione di opere ispirate ai tatuaggi unici, che raccontano storie e emozioni.' => array(
...
function marcello_scavo_translation_reminder() {
	...
	if ( ! $screen || ! in_array( $screen->base, array( 'dashboard', 'themes', 'appearance_page_theme-customizer' ) ) ) {
		return;
	}
...
function marcello_scavo_register_additional_footer_widgets() {
	...
	if ( $footer_layout === 'four_columns' ) {
		register_sidebar(
			array(
				'name'          => __( 'Footer Colonna 4', 'marcello-scavo' ),
				'id'            => 'footer-4',
				'description'   => __( 'Widget per la quarta colonna del footer (solo con layout 4 colonne).', 'marcello-scavo' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
...
function marcello_scavo_gallery_custom_columns( $columns ) {
	...
	$new_columns['image']            = __( 'Immagine', 'marcello-scavo' );
	$new_columns['title']            = $columns['title'];
	$new_columns['gallery_category'] = __( 'Categoria', 'marcello-scavo' );
	$new_columns['technique']        = __( 'Tecnica', 'marcello-scavo' );
	$new_columns['featured']         = __( 'In Evidenza', 'marcello-scavo' );
	...
	switch ( $column ) {
		...
		case 'gallery_category':
			...
			if ( ! empty( $terms ) ) {
				...
				echo '<span style="color: #999;">' . __( 'Nessuna categoria', 'marcello-scavo' ) . '</span>';
			}
			break;
		...
		case 'featured':
			...
			if ( $is_featured ) {
				echo '<span style="color: #c9b05f; font-weight: bold;">★ ' . __( 'Sì', 'marcello-scavo' ) . '</span>';
			} else {
				echo '<span style="color: #999;">' . __( 'No', 'marcello-scavo' ) . '</span>';
			}
			break;
	}
}
...
function marcello_scavo_gallery_admin_notice() {
	...
	if ( $screen->post_type === 'gallery' && $screen->base === 'edit' ) {
		...
		echo '<div><strong>' . __( 'Statistiche Galleria:', 'marcello-scavo' ) . '</strong></div>';
		echo '<div>📷 ' . $total_items . ' ' . __( 'immagini totali', 'marcello-scavo' ) . '</div>';
		echo '<div>⭐ ' . $featured_count . ' ' . __( 'in evidenza', 'marcello-scavo' ) . '</div>';
		echo '<div><a href="' . home_url( '/#gallery-btn' ) . '" target="_blank" class="button button-small">' . __( 'Visualizza Galleria Frontend', 'marcello-scavo' ) . '</a></div>';
		echo '</div>';
	}
}
...
class Marcello_Scavo_Portfolio_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Portfolio Recenti', 'marcello-scavo' ),
			array(
				'description' => __( 'Mostra i lavori del portfolio più recenti.', 'marcello-scavo' ),
	...
	public function widget( $args, $instance ) {
		...
		if ( $portfolio_posts ) {
			...
			echo '<p>' . __( 'Nessun lavoro nel portfolio al momento.', 'marcello-scavo' ) . '</p>';
		}
	...
	public function form( $instance ) {
		$title  = isset( $instance['title'] ) ? $instance['title'] : __( 'Portfolio Recenti', 'marcello-scavo' );
		$number = isset( $instance['number'] ) ? absint( $instance['number'] ) : 3;
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Titolo:', 'marcello-scavo' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Numero di lavori da mostrare:', 'marcello-scavo' ); ?></label>
...
class Marcello_Scavo_Contact_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Info Contatto', 'marcello-scavo' ),
			array(
				'description' => __( 'Mostra le informazioni di contatto dello studio.', 'marcello-scavo' ),
	...
	public function widget( $args, $instance ) {
		...
		echo '<h4><i class="fas fa-map-marker-alt"></i> ' . __( 'Milano', 'marcello-scavo' ) . '</h4>';
		echo '<p>' . nl2br( esc_html( get_theme_mod( 'contact_milano_address', 'Via Example, 123\n20121 Milano (MI)' ) ) ) . '</p>';
		echo '</div>';

		// Messina
		echo '<div class="contact-location">';
		echo '<h4><i class="fas fa-map-marker-alt"></i> ' . __( 'Messina', 'marcello-scavo' ) . '</h4>';
	...
	public function form( $instance ) {
		$title = isset( $instance['title'] ) ? $instance['title'] : __( 'Contatti Studio', 'marcello-scavo' );
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Titolo:', 'marcello-scavo' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
		</p>
		<p><em><?php _e( 'Le informazioni di contatto vengono prese dalle opzioni del tema nel Customizer.', 'marcello-scavo' ); ?></em></p>
		<?php
	}
...
class Marcello_Scavo_Contact_Card_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( '📧 Carta Contatto Personalizzata', 'marcello-scavo' ),
			array(
				'description' => __( 'Widget per creare carte contatto personalizzate con icone, titoli e azioni nella sezione contatti.', 'marcello-scavo' ),
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'description' ); ?>"><?php _e( 'Descrizione:', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'icon_class' ); ?>"><?php _e( 'Classe Icona FontAwesome:', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'contact_info' ); ?>"><?php _e( 'Informazioni di Contatto (opzionale):', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'button_text' ); ?>"><?php _e( 'Testo Pulsante (opzionale):', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'button_link' ); ?>"><?php _e( 'Link Pulsante (opzionale):', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'card_style' ); ?>"><?php _e( 'Stile Carta:', 'marcello-scavo' ); ?></label>
			<select class="widefat" id="<?php echo $this->get_field_id( 'card_style' ); ?>" name="<?php echo $this->get_field_name( 'card_style' ); ?>">
				<option value="default" <?php selected( $card_style, 'default' ); ?>><?php _e( 'Default', 'marcello-scavo' ); ?></option>
				<option value="highlight" <?php selected( $card_style, 'highlight' ); ?>><?php _e( 'Evidenziato (Oro)', 'marcello-scavo' ); ?></option>
				<option value="primary" <?php selected( $card_style, 'primary' ); ?>><?php _e( 'Primario (Navy)', 'marcello-scavo' ); ?></option>
			</select>
		</p>
...
class Marcello_Scavo_Location_Map_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( '🗺️ Mappa Personalizzata', 'marcello-scavo' ),
			array(
				'description' => __( 'Widget per creare mappe di localizzazione personalizzate con Google Maps, OpenStreetMap o iframe personalizzati.', 'marcello-scavo' ),
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'map_type' ); ?>"><?php _e( 'Tipo di Mappa:', 'marcello-scavo' ); ?></label>
			<select class="widefat" id="<?php echo $this->get_field_id( 'map_type' ); ?>" name="<?php echo $this->get_field_name( 'map_type' ); ?>">
				<option value="openstreetmap" <?php selected( $map_type, 'openstreetmap' ); ?>><?php _e( 'OpenStreetMap (Gratis)', 'marcello-scavo' ); ?></option>
				<option value="custom" <?php selected( $map_type, 'custom' ); ?>><?php _e( 'Iframe Personalizzato', 'marcello-scavo' ); ?></option>
			</select>
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id( 'address' ); ?>"><?php _e( 'Indirizzo:', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'latitude' ); ?>"><?php _e( 'Latitudine:', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'longitude' ); ?>"><?php _e( 'Longitudine:', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'zoom_level' ); ?>"><?php _e( 'Livello Zoom (1-20):', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'map_height' ); ?>"><?php _e( 'Altezza Mappa (px):', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'custom_iframe' ); ?>"><?php _e( 'Iframe Personalizzato:', 'marcello-scavo' ); ?></label>
			...
			<small><?php _e( 'Solo per "Iframe Personalizzato". Incolla qui il codice iframe da Google Maps, Bing o altri servizi.', 'marcello-scavo' ); ?></small>
		</p>
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['custom_iframe'] = ( ! empty( $new_instance['custom_iframe'] ) ) ? wp_kses(
			$new_instance['custom_iframe'],
			array(
				'iframe' => array(
					'src'             => array(),
					'width'           => array(),
...
class Marcello_Scavo_Instagram_Feed_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Instagram Feed (instafeed.js)', 'marcello-scavo' ),
			array(
				'description' => __( 'Widget Instagram personalizzato che utilizza instafeed.js per mostrare le foto.', 'marcello-scavo' ),
	...
	public function widget( $args, $instance ) {
		...
		if ( $show_profile ) {
			...
			echo '<p>' . __( 'Seguimi su Instagram per i miei ultimi lavori', 'marcello-scavo' ) . '</p>';
			echo '</div>';
			echo '</div>';
		}
		...
		echo '<i class="fas fa-spinner fa-spin"></i> ' . __( 'Caricamento feed Instagram...', 'marcello-scavo' );
		echo '</div>';
		...
		if ( $show_profile && ! empty( $profile_link ) ) {
			...
			echo '<i class="fab fa-instagram"></i> ' . __( 'Seguimi su Instagram', 'marcello-scavo' );
			echo '</a>';
		}
		...
		if ( $use_simple_mode ) {
			...
			echo '<div class="instagram-error">' . __( 'Modalità API: Token di accesso Instagram non configurato. Modalità Semplice: Attiva l\'opzione nel widget.', 'marcello-scavo' ) . '</div>';
		}
		...
		jQuery(document).ready(function($) {
			try {
				...
				var placeholderPosts = [
					...
					$default_posts = array(
						array(
							...
							'caption' => '🎨 Nuovo tatuaggio completato!',
						),
						array(
						...
						array(
							...
							'caption' => '🖋️ Sketch del giorno',
						),
						array(
							'image'   => 'https://picsum.photos/300/300?random=4',
							'caption' => '🌟 Dettagli artistici',
						),
						array(
							'image'   => 'https://picsum.photos/300/300?random=5',
							'caption' => '🎭 Arte e passione',
						),
						array(
							'image'   => 'https://picsum.photos/300/300?random=6',
							'caption' => '💫 Creatività infinita',
						),
					);
					...
					for ( $i = 1; $i <= 6; $i++ ) {
						...
						try {
							...
							} elseif ( ! empty( $custom_image_url ) && $this->is_local_attachment( $custom_image_url ) ) {
				...
				if (hasCustomImages.secure) {
					noteText = '<?php echo esc_js( __( '🔒 Immagini sicure caricate. Clicca per visitare Instagram.', 'marcello-scavo' ) ); ?>';
				} else if (hasCustomImages.custom) {
					noteText = '<?php echo esc_js( __( '⚠️ Immagini personalizzate. Clicca per visitare Instagram.', 'marcello-scavo' ) ); ?>';
				} else {
					noteText = '<?php echo esc_js( __( '📱 Modalità semplice attiva. Clicca sulle immagini per visitare Instagram.', 'marcello-scavo' ) ); ?>';
				}
				...
				if (typeof Instafeed !== 'undefined') {
					...
					try {
						var feed = new Instafeed({
							...
							error: function(message) {
								...
								$('#instagram-loading').hide();
								$('#instagram-error').show().html('<?php echo esc_js( __( 'Errore nel caricamento del feed Instagram. Verifica il token di accesso.', 'marcello-scavo' ) ); ?>');
							}
						});
						...
						$('#instagram-loading').hide();
						$('#instagram-error').show().html('<?php echo esc_js( __( 'Errore nell\'inizializzazione del feed Instagram.', 'marcello-scavo' ) ); ?>');
					}
				} else {
					...
					if (!window.instafeedScriptLoaded) {
						...
						script.onerror = function() {
							...
							$('#instagram-loading').hide();
							$('#instagram-error').show().html('<?php echo esc_js( __( 'Instafeed.js non è caricato. Verifica che lo script sia incluso correttamente.', 'marcello-scavo' ) ); ?>');
						};
	...
	public function form( $instance ) {
		$title            = isset( $instance['title'] ) ? $instance['title'] : __( 'I miei ultimi post Instagram', 'marcello-scavo' );
		$access_token     = isset( $instance['access_token'] ) ? $instance['access_token'] : '';
		$num_photos       = isset( $instance['num_photos'] ) ? absint( $instance['num_photos'] ) : 6;
		$show_profile     = isset( $instance['show_profile'] ) ? (bool) $instance['show_profile'] : true;
		$profile_username = isset( $instance['profile_username'] ) ? $instance['profile_username'] : 'marcelloscavo_art';
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'access_token' ); ?>"><?php _e( 'Instagram Access Token:', 'marcello-scavo' ); ?></label>
			...
			<small><?php _e( 'Inserisci il tuo Instagram Access Token. Vedi la documentazione per maggiori dettagli.', 'marcello-scavo' ); ?></small>
			<?php if ( ! empty( $access_token ) ) : ?>
				<br><small style="color: green;">✓ <?php _e( 'Token configurato', 'marcello-scavo' ); ?></small>
			<?php else : ?>
				<br><small style="color: red;">✗ <?php _e( 'Token mancante', 'marcello-scavo' ); ?></small>
			<?php endif; ?>
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id( 'num_photos' ); ?>"><?php _e( 'Numero di foto:', 'marcello-scavo' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_profile' ); ?>"><?php _e( 'Mostra informazioni profilo', 'marcello-scavo' ); ?></label>
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id( 'profile_username' ); ?>"><?php _e( 'Username Instagram:', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'profile_link' ); ?>"><?php _e( 'Link profilo Instagram:', 'marcello-scavo' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'use_simple_mode' ); ?>"><?php _e( '🔒 Usa modalità semplice con uploader sicuro', 'marcello-scavo' ); ?></label>
			<br><small><?php _e( 'Attiva questa opzione per caricare le tue immagini direttamente nella Media Library di WordPress. Include uploader sicuro integrato.', 'marcello-scavo' ); ?></small>
		</p>
		
		<p><strong><?php _e( 'Modalità di utilizzo:', 'marcello-scavo' ); ?></strong></p>
		<ul style="margin-left: 20px;">
			<li><strong><?php _e( 'Modalità API:', 'marcello-scavo' ); ?></strong> <?php _e( 'Inserisci il token di accesso Instagram per mostrare le foto reali del feed.', 'marcello-scavo' ); ?></li>
			<li><strong><?php _e( '🔒 Modalità Semplice:', 'marcello-scavo' ); ?></strong> <?php _e( 'Carica le tue immagini personali con l\'uploader sicuro integrato. Le immagini vengono salvate nella Media Library di WordPress.', 'marcello-scavo' ); ?></li>
		</ul>
		
		<div id="placeholder-images-section" style="border-top: 1px solid #ddd; padding-top: 15px; margin-top: 20px;">
			<h4><?php _e( '🎨 Immagini Personalizzate (Modalità Semplice)', 'marcello-scavo' ); ?></h4>
			<p><small><?php _e( 'Carica le tue immagini personalizzate per la modalità semplice. File sicuri salvati nella Media Library. Formati: JPG, PNG, WebP (max 2MB)', 'marcello-scavo' ); ?></small></p>
			...
			<div class="placeholder-image-row" style="border: 1px solid #e0e0e0; padding: 10px; margin-bottom: 10px; border-radius: 5px;">
				<p style="margin: 0 0 10px 0;"><strong><?php printf( __( 'Immagine %d:', 'marcello-scavo' ), $i ); ?></strong></p>
				...
				<div style="display: flex; gap: 10px; align-items: flex-start;">
					<div style="flex: 1;">
						<input class="widefat placeholder-image-display" 
								...
								type="text" 
								value="<?php echo $image_id ? sprintf( __( 'Immagine ID: %1$d (%2$s)', 'marcello-scavo' ), $image_id, basename( $image_url ) ) : __( 'Nessuna immagine selezionata', 'marcello-scavo' ); ?>" 
								readonly
					...
					<button type="button" class="button upload-secure-image" 
						...
						<?php _e( '🔒 Carica Sicuro', 'marcello-scavo' ); ?>
					</button>
					...
					<div style="display: flex; align-items: center; gap: 10px;">
						...
						<div>
							<p style="margin: 0; font-size: 11px; color: #666;">
								<strong><?php _e( 'Sicuro:', 'marcello-scavo' ); ?></strong> ID <?php echo $image_id; ?><br>
								<strong><?php _e( 'File:', 'marcello-scavo' ); ?></strong> <?php echo basename( $image_url ); ?>
							</p>
							<button type="button" class="button remove-secure-image" 
								...
								<?php _e( '🗑️ Rimuovi', 'marcello-scavo' ); ?>
							</button>
						</div>
					</div>
					<?php endif; ?>
				...
				<p style="margin: 10px 0 0 0;">
					<label for="<?php echo $this->get_field_id( "placeholder_caption_$i" ); ?>"><?php _e( 'Didascalia:', 'marcello-scavo' ); ?></label>
					<input class="widefat" 
							...
							placeholder="<?php _e( 'es. 🎨 Nuovo tatuaggio completato!', 'marcello-scavo' ); ?>"
							maxlength="200">
				</p>
			</div>
			<?php endfor; ?>
			...
			<div style="background: #e7f3ff; padding: 10px; border-radius: 5px; margin-top: 15px;">
				<p style="margin: 0; font-size: 12px;">
					<strong>🔒 <?php _e( 'Sicurezza:', 'marcello-scavo' ); ?></strong><br>
					• <?php _e( 'Le immagini sono salvate nella Media Library di WordPress', 'marcello-scavo' ); ?><br>
					• <?php _e( 'Solo immagini dal tuo sito sono accettate', 'marcello-scavo' ); ?><br>
					• <?php _e( 'Validazione automatica del tipo file (JPG, PNG, WebP)', 'marcello-scavo' ); ?><br>
					• <?php _e( 'Limite dimensione: 2MB per file', 'marcello-scavo' ); ?>
				</p>
			</div>
		</div>
		...
		jQuery(document).ready(function($) {
			...
			function initializeSecureUploader() {
				...
				$(document).off('click', '.upload-secure-image').on('click', '.upload-secure-image', function(e) {
					...
					if (!targetIdField.length || !targetUrlField.length || !targetDisplay.length) {
						alert('<?php _e( 'Errore: campi target non trovati', 'marcello-scavo' ); ?>');
					...
					if (typeof wp === 'undefined' || typeof wp.media === 'undefined') {
						alert('<?php _e( 'Media Library non disponibile. Ricarica la pagina.', 'marcello-scavo' ); ?>');
					...
					var media_uploader = wp.media({
						title: '<?php _e( '🔒 Seleziona Immagine Sicura', 'marcello-scavo' ); ?>',
						button: {
							text: '<?php _e( 'Usa questa immagine', 'marcello-scavo' ); ?>'
						},
						multiple: false,
						library: {
							type: 'image'
					...
					media_uploader.on('select', function() {
						...
						if (!attachment.id || !attachment.url) {
							alert('<?php _e( 'Errore: dati immagine non validi', 'marcello-scavo' ); ?>');
							return;
						}
						...
						if (allowedTypes.indexOf(attachment.mime) === -1) {
							alert('<?php _e( 'Formato non supportato. Usa JPG, PNG o WebP', 'marcello-scavo' ); ?>');
							return;
						}
						
						// Size validation (2MB max)
						if (attachment.filesizeInBytes && attachment.filesizeInBytes > 2097152) {
							alert('<?php _e( 'File troppo grande. Massimo 2MB', 'marcello-scavo' ); ?>');
							return;
						}
						...
						targetDisplay.val('<?php _e( 'Immagine ID:', 'marcello-scavo' ); ?> ' + attachment.id + ' (' + attachment.filename + ')');
			...
			$(document).on('click', '.remove-secure-image', function(e) {
				...
				if (!confirm('<?php _e( 'Sei sicuro di voler rimuovere questa immagine?', 'marcello-scavo' ); ?>')) {
					return;
				}
				...
				targetIdField.val('');
				targetUrlField.val('');
				targetDisplay.val('<?php _e( 'Nessuna immagine selezionata', 'marcello-scavo' ); ?>');
			...
			$('.upload-placeholder-image').on('click', function(e) {
				e.preventDefault();
				alert('<?php _e( 'Usa il nuovo sistema sicuro "🔒 Carica Sicuro" per maggiore sicurezza.', 'marcello-scavo' ); ?>');
			});
		});
		...
		function updateSecureImagePreview(container, attachment, uploadButton) {
			var previewHtml = '<div style="display: flex; align-items: center; gap: 10px;">' +
				...
				'<div>' +
				'<p style="margin: 0; font-size: 11px; color: #666;">' +
				'<strong><?php _e( 'Sicuro:', 'marcello-scavo' ); ?></strong> ID ' + attachment.id + '<br>' +
				'<strong><?php _e( 'File:', 'marcello-scavo' ); ?></strong> ' + attachment.filename +
				'</p>' +
				'<button type="button" class="button remove-secure-image" ' +
		...
		<p><strong><?php _e( 'Nota:', 'marcello-scavo' ); ?></strong> <?php _e( 'La modalità semplice è utile se hai difficoltà con la configurazione dell\'API di Instagram.', 'marcello-scavo' ); ?></p>
		<?php
	}
...
class Marcello_Scavo_Google_Reviews_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Recensioni Google Studio', 'marcello-scavo' ),
			array(
				'description' => __( 'Mostra le recensioni Google dello studio con animazioni innovative.', 'marcello-scavo' ),
	...
	public function form( $instance ) {
		$title             = isset( $instance['title'] ) ? $instance['title'] : __( 'Cosa dicono i nostri clienti', 'marcello-scavo' );
		$show_google_stats = isset( $instance['show_google_stats'] ) ? (bool) $instance['show_google_stats'] : true;
		$animation_type    = isset( $instance['animation_type'] ) ? $instance['animation_type'] : 'slide';
		$auto_rotate       = isset( $instance['auto_rotate'] ) ? (bool) $instance['auto_rotate'] : true;
		$rotation_speed    = isset( $instance['rotation_speed'] ) ? absint( $instance['rotation_speed'] ) : 5;
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_google_stats' ); ?>"><?php _e( 'Mostra statistiche Google', 'marcello-scavo' ); ?></label>
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id( 'animation_type' ); ?>"><?php _e( 'Tipo animazione:', 'marcello-scavo' ); ?></label>
			<select class="widefat" id="<?php echo $this->get_field_id( 'animation_type' ); ?>" name="<?php echo $this->get_field_name( 'animation_type' ); ?>">
				<option value="slide" <?php selected( $animation_type, 'slide' ); ?>><?php _e( 'Slide', 'marcello-scavo' ); ?></option>
				<option value="fade" <?php selected( $animation_type, 'fade' ); ?>><?php _e( 'Fade', 'marcello-scavo' ); ?></option>
				<option value="scale" <?php selected( $animation_type, 'scale' ); ?>><?php _e( 'Scale', 'marcello-scavo' ); ?></option>
			</select>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'auto_rotate' ); ?>"><?php _e( 'Rotazione automatica', 'marcello-scavo' ); ?></label>
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id( 'rotation_speed' ); ?>"><?php _e( 'Velocità rotazione (secondi):', 'marcello-scavo' ); ?></label>
...
class Marcello_Scavo_Bookly_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Bookly Prenotazioni', 'marcello-scavo' ),
			array(
				'description' => __( 'Widget per integrare Bookly o altri sistemi di prenotazione.', 'marcello-scavo' ),
	...
	public function widget( $args, $instance ) {
		...
		if ( $show_features ) {
			...
			echo '<h4>' . __( 'Prenotazione Online', 'marcello-scavo' ) . '</h4>';
			echo '<p>' . __( 'Sistema sicuro e veloce', 'marcello-scavo' ) . '</p>';
			echo '</div>';

			echo '<div class="feature-item">';
			echo '<div class="feature-icon"><i class="fas fa-clock"></i></div>';
			echo '<h4>' . __( 'Orari Flessibili', 'marcello-scavo' ) . '</h4>';
			echo '<p>' . __( 'Milano e Messina', 'marcello-scavo' ) . '</p>';
			echo '</div>';

			echo '<div class="feature-item">';
			echo '<div class="feature-icon"><i class="fas fa-paint-brush"></i></div>';
			echo '<h4>' . __( 'Consulenza Gratuita', 'marcello-scavo' ) . '</h4>';
			echo '<p>' . __( 'Design personalizzato', 'marcello-scavo' ) . '</p>';
			echo '</div>';
		...
		if ( ! empty( $bookly_shortcode ) ) {
			...
			echo '<h3>' . __( 'Sistema di Prenotazione', 'marcello-scavo' ) . '</h3>';
			echo '<p>' . __( 'Per configurare il sistema di prenotazione, inserisci lo shortcode di Bookly nel widget.', 'marcello-scavo' ) . '</p>';
			echo '<div class="booking-info">';
			echo '<p><strong>' . __( 'Esempio shortcode Bookly:', 'marcello-scavo' ) . '</strong></p>';
		...
		echo '<p class="alternative-text">' . __( 'Preferisci chiamare?', 'marcello-scavo' ) . '</p>';
	...
	public function form( $instance ) {
		$title            = isset( $instance['title'] ) ? $instance['title'] : __( 'Prenota il tuo tatuaggio oggi!', 'marcello-scavo' );
		$subtitle         = isset( $instance['subtitle'] ) ? $instance['subtitle'] : __( 'Scopri l\'arte del tatuaggio e prenota il tuo appuntamento per un\'esperienza unica.', 'marcello-scavo' );
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'subtitle' ); ?>"><?php _e( 'Sottotitolo:', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'bookly_shortcode' ); ?>"><?php _e( 'Shortcode Bookly:', 'marcello-scavo' ); ?></label>
			...
			<small><?php _e( 'Es: [bookly-form] o [bookly-form category_id="1"]', 'marcello-scavo' ); ?></small>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_features' ); ?>"><?php _e( 'Mostra caratteristiche del servizio', 'marcello-scavo' ); ?></label>
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id( 'cta_text' ); ?>"><?php _e( 'Testo aggiuntivo (opzionale):', 'marcello-scavo' ); ?></label>
			...
			<small><?php _e( 'Testo che apparirà sotto il form di prenotazione.', 'marcello-scavo' ); ?></small>
		</p>
		
		<hr>
		<p><strong><?php _e( 'Istruzioni:', 'marcello-scavo' ); ?></strong></p>
		<ol>
			<li><?php _e( 'Installa e configura il plugin Bookly', 'marcello-scavo' ); ?></li>
			<li><?php _e( 'Crea un servizio "Tatuaggio" in Bookly', 'marcello-scavo' ); ?></li>
			<li><?php _e( 'Copia lo shortcode generato da Bookly', 'marcello-scavo' ); ?></li>
			<li><?php _e( 'Incollalo nel campo "Shortcode Bookly"', 'marcello-scavo' ); ?></li>
		</ol>
		<?php
	}
...
class Marcello_Scavo_Gallery_Showcase_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Galleria Creazioni Artistiche', 'marcello-scavo' ),
			array(
				'description' => __( 'Mostra la galleria dei lavori artistici con slider categorizzato e filtri.', 'marcello-scavo' ),
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty( $categories ) && ! is_wp_error( $categories ) ) {
			...
			if ( $show_category_filter && $display_mode === 'categorized_slider' ) {
				...
				echo '<button class="filter-tab active" data-category="all">' . __( 'Tutte le Opere', 'marcello-scavo' ) . '</button>';
			...
			echo '<i class="fas fa-images"></i> ' . __( 'Visualizza Tutta la Galleria', 'marcello-scavo' );
			echo '</button>';
			echo '</div>';
			...
			echo '<h3>' . __( 'Galleria in Costruzione', 'marcello-scavo' ) . '</h3>';
			echo '<p>' . __( 'Presto vedrai qui le mie creazioni artistiche più belle!', 'marcello-scavo' ) . '</p>';
			echo '</div>';
			echo '</div>';
		}
	...
	private function render_gallery_grid( $category_slug, $count ) {
		...
		if ( $gallery_posts ) {
			...
			echo '<p>' . __( 'Nessun elemento in questa categoria al momento.', 'marcello-scavo' ) . '</p>';
			echo '</div>';
		}
	}
	...
	private function render_gallery_item( $post ) {
		...
		if ( has_post_thumbnail( $post->ID ) ) {
			...
			echo '<button class="gallery-zoom-btn" title="' . __( 'Visualizza', 'marcello-scavo' ) . '">';
	...
	public function form( $instance ) {
		$title                = isset( $instance['title'] ) ? $instance['title'] : __( 'Scopri le mie creazioni artistiche', 'marcello-scavo' );
		$subtitle             = isset( $instance['subtitle'] ) ? $instance['subtitle'] : __( 'Esplora una collezione di opere ispirate ai tatuaggi unici, che raccontano storie e emozioni.', 'marcello-scavo' );
		$display_mode         = isset( $instance['display_mode'] ) ? $instance['display_mode'] : 'categorized_slider';
		$items_per_category   = isset( $instance['items_per_category'] ) ? absint( $instance['items_per_category'] ) : 6;
		$show_category_filter = isset( $instance['show_category_filter'] ) ? (bool) $instance['show_category_filter'] : true;
		$auto_rotate          = isset( $instance['auto_rotate'] ) ? (bool) $instance['auto_rotate'] : true;
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'display_mode' ); ?>"><?php _e( 'Modalità di visualizzazione:', 'marcello-scavo' ); ?></label>
			<select class="widefat" id="<?php echo $this->get_field_id( 'display_mode' ); ?>" name="<?php echo $this->get_field_name( 'display_mode' ); ?>">
				<option value="categorized_slider" <?php selected( $display_mode, 'categorized_slider' ); ?>><?php _e( 'Slider Categorizzato', 'marcello-scavo' ); ?></option>
				<option value="masonry_grid" <?php selected( $display_mode, 'masonry_grid' ); ?>><?php _e( 'Griglia Masonry', 'marcello-scavo' ); ?></option>
				<option value="featured_carousel" <?php selected( $display_mode, 'featured_carousel' ); ?>><?php _e( 'Carousel In Evidenza', 'marcello-scavo' ); ?></option>
			</select>
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id( 'items_per_category' ); ?>"><?php _e( 'Elementi per categoria:', 'marcello-scavo' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_category_filter' ); ?>"><?php _e( 'Mostra filtri categoria', 'marcello-scavo' ); ?></label>
		</p>
		
		<p>
			<input class="checkbox" type="checkbox" <?php checked( $auto_rotate ); ?> id="<?php echo $this->get_field_id( 'auto_rotate' ); ?>" name="<?php echo $this->get_field_name( 'auto_rotate' ); ?>" />
			<label for="<?php echo $this->get_field_id( 'auto_rotate' ); ?>"><?php _e( 'Rotazione automatica (carousel)', 'marcello-scavo' ); ?></label>
		</p>
		...
		<hr>
		<p><strong><?php _e( 'Categorie disponibili:', 'marcello-scavo' ); ?></strong></p>
		<?php
		$categories = get_terms(
			array(
				'taxonomy'   => 'gallery_category',
		...
		if ( ! empty( $categories ) && ! is_wp_error( $categories ) ) {
			...
			echo '<p><em>' . __( 'Nessuna categoria trovata. Crea categorie in Galleria > Categorie.', 'marcello-scavo' ) . '</em></p>';
		}
		?>
		<?php
	}
...
function handle_instagram_image_cleanup() {
	try {
		...
		if ( ! current_user_can( 'edit_theme_options' ) ) {
			wp_die( __( 'Permessi insufficienti', 'marcello-scavo' ), 403 );
		}

		if ( ! isset( $_POST['nonce'] ) || ! wp_verify_nonce( $_POST['nonce'], 'cleanup_instagram_image' ) ) {
			wp_die( __( 'Nonce non valido', 'marcello-scavo' ), 403 );
		}
		...
		if ( $image_id > 0 ) {
			...
			wp_send_json_success( array( 'message' => __( 'Immagine rimossa dal widget', 'marcello-scavo' ) ) );
		} else {
			wp_send_json_error( array( 'message' => __( 'ID immagine non valido', 'marcello-scavo' ) ) );
		}
	} catch ( Exception $e ) {
		wp_send_json_error( array( 'message' => __( 'Errore durante la rimozione', 'marcello-scavo' ) ) );
	}
}
...
function handle_instagram_image_cleanup_nopriv() {
	wp_die( __( 'Accesso negato', 'marcello-scavo' ), 403 );
}
...
function validate_instagram_upload( $file ) {
	try {
		...
		if ( ! in_array( $file['type'], $allowed_types ) ) {
			return new WP_Error( 'invalid_type', __( 'Tipo file non consentito per widget Instagram', 'marcello-scavo' ) );
		}

		// Check file size (2MB max)
		if ( $file['size'] > 2097152 ) {
			return new WP_Error( 'file_too_large', __( 'File troppo grande per widget Instagram (max 2MB)', 'marcello-scavo' ) );
		}

		return $file;
	} catch ( Exception $e ) {
		return new WP_Error( 'validation_error', __( 'Errore durante la validazione del file', 'marcello-scavo' ) );
	}
}
...
class Marcello_Scavo_Footer_Content_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Footer Content', 'marcello-scavo' ),
			array(
				'description' => __( 'Widget personalizzato per aggiungere contenuto generico alle colonne del footer.', 'marcello-scavo' ),
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'content' ); ?>"><?php _e( 'Contenuto:', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'icon' ); ?>"><?php _e( 'Icona FontAwesome (es: fas fa-phone):', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'link_url' ); ?>"><?php _e( 'URL Link (opzionale):', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'link_text' ); ?>"><?php _e( 'Testo Link:', 'marcello-scavo' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'link_target' ); ?>"><?php _e( 'Apri link in nuova finestra', 'marcello-scavo' ); ?></label>
		</p>
		<?php
	}
...
class Marcello_Scavo_Footer_Contact_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Footer Contact Info', 'marcello-scavo' ),
			array(
				'description' => __( 'Widget per visualizzare informazioni di contatto nel footer.', 'marcello-scavo' ),
	...
	public function form( $instance ) {
		$title   = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Contatti', 'marcello-scavo' );
		$address = ! empty( $instance['address'] ) ? $instance['address'] : '';
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'phone' ); ?>"><?php _e( 'Telefono:', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'email' ); ?>"><?php _e( 'Email:', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'hours' ); ?>"><?php _e( 'Orari (opzionale):', 'marcello-scavo' ); ?></label>
...
class Marcello_Scavo_Footer_Social_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Footer Social Links', 'marcello-scavo' ),
			array(
				'description' => __( 'Widget per visualizzare link social nel footer con stile personalizzabile.', 'marcello-scavo' ),
	...
	public function form( $instance ) {
		$title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Seguici', 'marcello-scavo' );
		$style = ! empty( $instance['style'] ) ? $instance['style'] : 'modern';
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Titolo:', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'style' ); ?>"><?php _e( 'Stile Social Icons:', 'marcello-scavo' ); ?></label>
			<select class="widefat" id="<?php echo $this->get_field_id( 'style' ); ?>" name="<?php echo $this->get_field_name( 'style' ); ?>">
				<option value="modern" <?php selected( $style, 'modern' ); ?>><?php _e( 'Moderno (Circoli colorati)', 'marcello-scavo' ); ?></option>
				<option value="minimal" <?php selected( $style, 'minimal' ); ?>><?php _e( 'Minimale (Solo icone)', 'marcello-scavo' ); ?></option>
				<option value="buttons" <?php selected( $style, 'buttons' ); ?>><?php _e( 'Pulsanti (Con testo)', 'marcello-scavo' ); ?></option>
				<option value="cards" <?php selected( $style, 'cards' ); ?>><?php _e( 'Card (Stile card)', 'marcello-scavo' ); ?></option>
			</select>
		</p>
		
		<p><small><?php _e( 'I link social si configurano nel Personalizza > Layout Footer > Social Media.', 'marcello-scavo' ); ?></small></p>
		<?php
	}
...
function marcello_scavo_set_language( $lang_code ) {
	...
	if ( isset( $locale_map[ $lang_code ] ) ) {
		...
		unload_textdomain( 'marcello-scavo' );
		load_theme_textdomain( 'marcello-scavo', get_template_directory() . '/languages' );
	}
}
...
function marcello_scavo_register_portfolio_widgets() {
	register_sidebar(
		array(
			'name'          => __( 'Portfolio - Galleria', 'marcello-scavo' ),
			'id'            => 'portfolio-gallery',
			'description'   => __( 'Widget per la galleria d’arte nella pagina Portfolio.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Portfolio - Tatuaggi Recenti', 'marcello-scavo' ),
			'id'            => 'portfolio-latest',
			'description'   => __( 'Widget per i tatuaggi recenti nella pagina Portfolio.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Portfolio - Testimonianze', 'marcello-scavo' ),
			'id'            => 'portfolio-testimonials',
			'description'   => __( 'Widget per le recensioni/testimonianze nella pagina Portfolio.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Portfolio - Prenotazione', 'marcello-scavo' ),
			'id'            => 'portfolio-cta',
			'description'   => __( 'Widget per la call-to-action/prenotazione nella pagina Portfolio.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Portfolio - Mappa', 'marcello-scavo' ),
			'id'            => 'portfolio-map',
			'description'   => __( 'Widget per la mappa/localizzazione nella pagina Portfolio.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Portfolio - Social', 'marcello-scavo' ),
			'id'            => 'portfolio-social',
			'description'   => __( 'Widget per i social nella pagina Portfolio.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Portfolio - Slider Galleria', 'marcello-scavo' ),
			'id'            => 'portfolio-gallery-slider',
			'description'   => __( 'Widget slider per la galleria d\'arte nella pagina Portfolio. Alternativa alla griglia normale.', 'marcello-scavo' ),
...
class Marcello_Scavo_Portfolio_Slider_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Portfolio Slider', 'marcello-scavo' ),
			array(
				'description' => __( 'Slider per mostrare la galleria del portfolio con effetti di transizione.', 'marcello-scavo' ),
			)
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( $portfolio_query->have_posts() ) {
			...
			while ( $portfolio_query->have_posts() ) {
				...
				echo '<a href="' . get_permalink() . '" class="portfolio-slider-link">' . __( 'Visualizza', 'marcello-scavo' ) . '</a>';
				echo '</div>';
				echo '</div>';
				echo '</div>';
				echo '</div>';
			...
			echo '<button class="portfolio-slider-prev" aria-label="' . __( 'Slide precedente', 'marcello-scavo' ) . '">‹</button>';
			echo '<button class="portfolio-slider-next" aria-label="' . __( 'Slide successiva', 'marcello-scavo' ) . '">›</button>';
			echo '</div>';

			// Indicatori
			echo '<div class="portfolio-slider-dots">';
			for ( $i = 0; $i < $portfolio_query->post_count; $i++ ) {
				echo '<button class="portfolio-slider-dot' . ( $i === 0 ? ' active' : '' ) . '" data-slide="' . $i . '" aria-label="' . sprintf( __( 'Vai alla slide %s', 'marcello-scavo' ), $i + 1 ) . '"></button>';
			}
			echo '</div>';

			echo '</div>';
		} else {
			echo '<p class="no-portfolio-items">' . __( 'Nessun lavoro del portfolio trovato.', 'marcello-scavo' ) . '</p>';
		}
	...
	public function form( $instance ) {
		$title          = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Galleria Portfolio', 'marcello-scavo' );
		$category       = ! empty( $instance['category'] ) ? $instance['category'] : '';
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Titolo:', 'marcello-scavo' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php _e( 'Categoria Portfolio:', 'marcello-scavo' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'posts_per_page' ) ); ?>"><?php _e( 'Numero di slide:', 'marcello-scavo' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'autoplay' ) ); ?>"><?php _e( 'Autoplay slider', 'marcello-scavo' ); ?></label>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'autoplay_speed' ) ); ?>"><?php _e( 'Velocità autoplay (ms):', 'marcello-scavo' ); ?></label>
...
function marcello_scavo_register_taxonomy_portfolio_widgets() {
	register_sidebar(
		array(
			'name'          => __( 'Taxonomy Portfolio - Hero Section', 'marcello-scavo' ),
			'id'            => 'taxonomy-portfolio-hero',
			'description'   => __( 'Widget per personalizzare la hero section delle categorie portfolio.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Taxonomy Portfolio - Galleria', 'marcello-scavo' ),
			'id'            => 'taxonomy-portfolio-gallery',
			'description'   => __( 'Widget per personalizzare la sezione galleria delle categorie portfolio.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Taxonomy Portfolio - Lavori Recenti', 'marcello-scavo' ),
			'id'            => 'taxonomy-portfolio-latest',
			'description'   => __( 'Widget per personalizzare la sezione lavori recenti delle categorie portfolio.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Taxonomy Portfolio - Testimonianze', 'marcello-scavo' ),
			'id'            => 'taxonomy-portfolio-testimonials',
			'description'   => __( 'Widget per personalizzare la sezione testimonianze delle categorie portfolio.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Taxonomy Portfolio - Prenota Appuntamento', 'marcello-scavo' ),
			'id'            => 'taxonomy-portfolio-booking',
			'description'   => __( 'Widget per il modulo di prenotazione appuntamenti (es. Bookly). Inserire qui il plugin di prenotazione.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Taxonomy Portfolio - CTA Generale', 'marcello-scavo' ),
			'id'            => 'taxonomy-portfolio-cta',
			'description'   => __( 'Widget per chiamate all\'azione generali delle categorie portfolio.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Taxonomy Portfolio - Perché Sceglierci', 'marcello-scavo' ),
			'id'            => 'taxonomy-portfolio-why',
			'description'   => __( 'Widget per personalizzare la sezione "Perché sceglierci" delle categorie portfolio.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Taxonomy Portfolio - Contatti', 'marcello-scavo' ),
			'id'            => 'taxonomy-portfolio-contact',
			'description'   => __( 'Widget per personalizzare la sezione contatti delle categorie portfolio.', 'marcello-scavo' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
