...
<section class="portfolio-testimonials-section">
    <div class="container">
        <?php if (is_active_sidebar('taxonomy-portfolio-testimonials')) : ?>
            <div class="taxonomy-portfolio-testimonials-widget-area">
                <?php dynamic_sidebar('taxonomy-portfolio-testimonials'); ?>
            </div>
        <?php else : ?>
            <div class="section-header">
