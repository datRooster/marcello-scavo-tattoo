	...
	<div class="container">
		<div class="portfolio-hero-content">
			...
			<div class="portfolio-hero-cta">
				<a href="#galleria" class="btn btn-outline-light btn-hero"><?php _e('Esplora la Galleria', 'marcello-scavo-tattoo'); ?></a>
			</div>
		</div>
	</div>
							...
							<div class="portfolio-latest-image">
								...
								<div class="portfolio-latest-overlay">
									<div class="portfolio-latest-content">
										...
										<a href="<?php the_permalink(); ?>" class="portfolio-latest-link"><?php _e('Scopri di più', 'marcello-scavo-tattoo'); ?></a>
									</div>
								</div>
							</div>
						</div>
		...
		<?php else : ?>
			<div class="portfolio-cta-content">
				...
				<div class="cta-buttons">
					<a href="#contatti" class="btn btn-primary btn-large"><?php _e('Prenota Consulenza', 'marcello-scavo-tattoo'); ?></a>
					<a href="<?php echo esc_url(get_post_type_archive_link('portfolio')); ?>" class="btn btn-outline btn-large"><?php _e('Vedi Portfolio', 'marcello-scavo-tattoo'); ?></a>
				</div>
